        ...
        .then((doc) => {
            ...
            settings.findOne({})
                .then((doc1) => {
                    ...
                    doc1.paymentdisabled = req.body.disablepaymentd;
                    doc1.creditbuilder = req.body.credit;
                    doc1.supportedCuurrency = req.body.payment_currency;
                    ...
                    doc1.storepolicy = req.body.storepolicy !== "none" ? req.body.storepolicy : doc1.storepolicy;
